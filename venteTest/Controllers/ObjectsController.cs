...
using venteTest.Models.ObjectViewModels;
...
namespace venteTest.Controllers
{
    ...
    public class ObjectsController : Controller
    {
        ...
        public ObjectsController(ApplicationDbContext context, IHostingEnvironment e) {
            _context = context;
            he = e;
        }

        // GET: Objects
        public async Task<IActionResult> Index() { // ListerObjectViewModel .. Liste des objets pour annonces
