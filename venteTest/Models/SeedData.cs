    ...
    public class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider, IConfiguration Configuration)
        {
            ...
            if (!context.Objets.Any())
            {
                ...
                context.Objets.Add(new Objet() { Nom = "Sauder Kids Storage", Description= "Sauder Kids Storage Chest for Toys, Blankets, Clothes - Oiled Oak Finish",PrixDepart= 170d,DateInscription=DateTime.Parse("2018-05-10"),DateLimite= DateTime.Parse("2018-06-04"),Status=Status.EnVente,imageUrl= "Uploads/kidStorage.jpg",CategorieID=1,Vendeur= vendeur, ConfigurationAdmin = configurationAdmin });
                ...
                context.Objets.Add(new Objet() { Nom = "Alcohol Breath Tester", Description = "LCD Digital Alcohol Breath Tester Breathalyzer Analyzer Detector Test AT6000", PrixDepart = 10d, DateInscription = DateTime.Parse("2018-05-10"), DateLimite = DateTime.Parse("2018-06-04"), Status = Status.EnVente, imageUrl = "Uploads/Alcoholtest.jpg", CategorieID = 7, Vendeur= vendeur, ConfigurationAdmin = configurationAdmin });
                context.Objets.Add(new Objet() { Nom = "Sport Camera phones", Description = "Zhiyun Crane-M 3-Axis Gimbal Stabilizer for Mirrorless/Sport Camera phones", PrixDepart = 235d, DateInscription = DateTime.Parse("2018-05-10"), DateLimite = DateTime.Parse("2018-06-04"), Status = Status.EnVente, imageUrl = "Uploads/CameraPhone.jpg", CategorieID = 12, Vendeur= vendeur, ConfigurationAdmin = configurationAdmin });
                ...
                context.Objets.Add(new Objet() { Nom = "Dell Precision T5400", Description = "Dell Precision T5400 2 x Xeon Quad Core E5420 2.50Ghz 16GB RAM 500Gb HDD", PrixDepart = 200d, DateInscription = DateTime.Parse("2018-05-10"), DateLimite = DateTime.Parse("2018-06-04"), Status = Status.EnVente, imageUrl = "Uploads/Desktop.jpg", CategorieID = 15, Vendeur= vendeur, ConfigurationAdmin = configurationAdmin });
                ...
                context.Objets.Add(new Objet() { Nom = "Cologne for Men", Description = "Azzaro Pour Homme Cologne for Men 100ml EDT Spray", PrixDepart = 10d, DateInscription = DateTime.Parse("2018-05-11"), DateLimite = DateTime.Parse("2018-05-12"), Status = Status.Vendu, imageUrl = "Uploads/Parfum.jpg", CategorieID = 17, Vendeur= vendeur, ConfigurationAdmin = configurationAdmin });
                context.SaveChanges();
            ...
            if (!context.Encheres.Any()) 
            {
                ...
                // Mise gagnante fait par l'admin ( sasha.bouchard@gmail.com )
                context.Encheres.Add(new Enchere() { Objet = objet, Niveau = objet.PrixDepart + (double)objet.ConfigurationAdmin.PasGlobalEnchere, MiseMax = 15, Miseur = (Miseur)UserManager.Users.FirstOrDefault(p => p.UserName.Equals("sasha.bouchard@gmail.com")) });
                ...
                objet.VenteEvaluation = new VenteEvaluation { Acheteur = (Miseur)UserManager.Users.FirstOrDefault(p => p.UserName.Equals("sasha.bouchard@gmail.com")), Objet = objet, Commentaire = "L'acheteur était très indécis et agressif lors de la transaction, mais il a quand même payé...", Cote = -1, DateEvaluation = DateTime.Now };
